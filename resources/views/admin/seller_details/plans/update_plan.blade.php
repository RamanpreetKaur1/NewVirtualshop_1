...
<head>
    ...
    <style>
        ...
        #generic_price_table .generic_content:hover .generic_head_price .generic_head_content .head_bg {
            border-color: #556ee6 rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #556ee6;
            color: #fff;
        }
...
<body>
    <div class="text-sm-end m-4">
        <a href="{{ url('admin/dashboard') }}"><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light"><i class="bx bx-arrow-back me-1"></i> Back</button>  </a>
    </div>
    <form method="POST" action="{{ url('admin/update_plan/'.$seller_plan_view->id) }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="generic_content clearfix">
                                ...
                                <div class="generic_price_btn clearfix">
                                    <button type="submit" name="plan_a" value="plan_a" class="btn btn-primary">Update Plan</button>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="generic_content active clearfix">
                                ...
                                <!--BUTTON START-->
                                <div class="generic_price_btn clearfix">
                                    <button type="submit" name="plan_b" value="plan_b" class="btn btn-primary">Update Plan </button>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="generic_content clearfix">
                                ...
                                <!--BUTTON START-->
                                <div class="generic_price_btn clearfix">
                                    <button type="submit" name="plan_c" value="plan_c" class="btn btn-primary">Update Plan </button>
